    ...
    return (
        <DialogContent>
            <div className="flex flex-col gap-6 h-full">
                ...
                <form onSubmit={handleSubmit(handleCreateGoal)} action="" className="flex-1 flex flex-col justify-between">
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                            <Label htmlFor="title">Qual a atividade?</Label>
                            <Input {...register('title')} id="title" autoFocus placeholder='Praticar exercícios, meditar, etc...' />
